...
**Tracking the mechanics, stages, and systems behind a 2D action game.**
...
PIGGY ONE SUPER SPARK is a single-player 2D action platformer set in a colorful futuristic world. Xiamy, Yuez, and a lost newborn travel together while facing dark monsters, puzzles, and unusual characters. Development is ongoing, with this repository documenting pre-alpha iteration.

This devlog may interest players and developers following 2D action-platformer production.
...
- ⚡ **Character Abilities** — Xiamy uses speed, Yuez uses strength, and the baby has powers of its own.
- 🧲 **Magnetism and Electricity** — Magnetic and electrical abilities support combat and puzzle interactions.
- 📞 **Road-Trip Structure** — The trio travels between encounters using a phone booth as their vehicle.
- 🌱 **Pre-Alpha Development** — The journal records ongoing work on stages, mechanics, and implementation.

## 📸 Screenshots

<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2780230/ss_ce427d1faa6d3ea69f4f58800bb49411dd8b25c6.1920x1080.jpg?t=1785736670" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2780230/ss_3f9b045fd736e91d9f5f2f7ec7131d46c87adeb2.1920x1080.jpg?t=1785736670" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2780230/ss_84383652a28914c802584948683bcfdd57e11ad9.1920x1080.jpg?t=1785736670" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
| **Processor** | Intel Core i5 | Intel Core i5 or AMD Ryzen 5 |
| **RAM** | 2 GB | 8 GB |
| **Graphics** | DirectX 11 compatible graphics | DirectX 11 compatible graphics with 2 GB VRAM |
| **Storage** | 2 GB available space | 2 GB available space on an SSD |
| **Additional** | DirectX 11 | DirectX 12 and current graphics drivers |
